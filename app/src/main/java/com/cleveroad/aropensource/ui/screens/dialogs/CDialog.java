package com.cleveroad.aropensource.ui.screens.dialogs;
...
import static com.cleveroad.aropensource.ui.screens.dialogs.CDConstants.LARGE;
import static com.cleveroad.aropensource.ui.screens.dialogs.CDConstants.MEDIUM;
import static com.cleveroad.aropensource.ui.screens.dialogs.CDConstants.POSITION_BOTTOM;
import static com.cleveroad.aropensource.ui.screens.dialogs.CDConstants.POSITION_TOP;
import static com.cleveroad.aropensource.ui.screens.dialogs.CDConstants.SUCCESS;
import static com.cleveroad.aropensource.ui.screens.dialogs.CDConstants.WARNING;
...
public class CDialog {
    ...
    public CDialog(Context context, Bitmap bitmap) {
        this.context = context;
        dialog = new Dialog(context);
        this.bitmap = bitmap;
    }
    ...
    public CDialog createAlert(String message, int alertType, int givenSize) {
        ...
        messageTextView = dialog.findViewById(R.id.name_msg);
    ...
    public CDialog createFaceAlert(String name, String desc, String reward, String rating, Bitmap icon, int alertType, int givenSize) {

        dialog.getWindow().setBackgroundDrawableResource(R.drawable.circularbordersolid);
        dialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.face_detect);
        dialog.getWindow().getAttributes().windowAnimations = R.style.slide_from_left_to_right;
        switch (givenSize) {
            case MEDIUM:
                size = context.getResources().getInteger(R.integer.medium_dialog);
        ...
        ((TextView) dialog.findViewById(R.id.tv_desc)).setText(desc);
        ((TextView) dialog.findViewById(R.id.tv_reward)).setText(reward);
        ((TextView) dialog.findViewById(R.id.tv_rating)).setText(rating);
        imageView = dialog.findViewById(R.id.iv_face);
        imageView.setImageBitmap(icon);
        return this;
    }
